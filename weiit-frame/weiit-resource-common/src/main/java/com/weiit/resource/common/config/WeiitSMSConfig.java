...
public class WeiitSMSConfig {
	 ...
	 * 阿里云短信服务配置
	 */
	public static String smsAliAccessKeyId = "LTAI5tCHJwvfsDEwNvnj2usS";//阿里云短信的AccessKeyId
	public static String smsAliAccessKeySecret = "1728c5Ur9OplFsBnzgXbG1uHAHt2hl";//阿里云短信的AccessKeySecret
	public static String smsAliSign="康美汇生活";//阿里云短信的签名
